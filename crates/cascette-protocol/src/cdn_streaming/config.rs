...
impl CdnConfig {
    ...
    pub fn default_cdn_servers() -> Vec<CdnServer> {
        vec![
            // Primary Blizzard CDNs (highest priority)
            CdnServer::new("level3.blizzard.com".to_string(), true, 10),
            CdnServer::new("edgecast.blizzard.com".to_string(), true, 20),
            CdnServer::new("eu.cdn.blizzard.com".to_string(), true, 30),
            // Community mirrors (lower priority, HTTP fallback)
            CdnServer::new("cdn.arctium.tools".to_string(), false, 100),
    ...
    /// Create configuration for development/testing with local mirrors
    pub fn development() -> Self {
        Self {
            servers: vec![
                // Prefer community mirrors for development
                CdnServer::new("cdn.arctium.tools".to_string(), false, 10),
                CdnServer::new("casc.wago.tools".to_string(), true, 20),
            ],
        ...
        Self {
            ...
            cdn: CdnConfig {
                servers: vec![
                    ...
                    CdnServer::new("level3.blizzard.com".to_string(), true, 10),
                    CdnServer::new("cdn.arctium.tools".to_string(), false, 20),
                ],
                max_failover_attempts: 2,
