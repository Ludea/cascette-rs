...
impl HttpClient {
    ...
    fn create_optimized_client() -> Result<Client> {
        ClientBuilder::new()
            ...
            // TLS optimization - use native TLS for faster startup
            .use_native_tls() // Faster startup than rustls
...
#[allow(clippy::struct_excessive_bools)] // Configuration struct needs granular control
#[derive(Debug, Clone)]
pub struct HttpConfig {
    ...
    /// Use native TLS instead of rustls (faster startup)
...
impl Default for HttpConfig {
    fn default() -> Self {
        Self {
            ...
            use_native_tls: true,         // Faster startup than rustls
