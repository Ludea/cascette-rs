...
impl<'a> CertificateFetcher<'a> {
    ...
    fn parse_certificate_response(&self, response: &str) -> Result<CertificateInfo> {
    ...
    fn extract_pem_certificate(&self, response: &str) -> Result<String> {
    ...
    fn parse_pem_certificate(&self, cert_pem: &str) -> Result<Certificate> {
    ...
    fn extract_subject_key_identifier(&self, cert: &Certificate) -> Result<String> {
    ...
    fn extract_public_key_info_from_der(&self, spki_der: &[u8]) -> Result<PublicKeyInfo> {
    ...
    fn estimate_rsa_key_size(&self, key_bytes: &[u8]) -> usize {
    ...
    fn estimate_ec_key_size(&self, key_bytes: &[u8]) -> usize {
    ...
    fn oid_to_algorithm_name(&self, oid: &der::asn1::ObjectIdentifier) -> String {
