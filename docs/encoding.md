...
- `b:{start,size}` - Byte range specification
...
- Page sizes are powers of 2 (typically 4KB)

- Key sizes are fixed (usually 16 bytes)
...
### Python Tools (tools/examine_encoding.py)
